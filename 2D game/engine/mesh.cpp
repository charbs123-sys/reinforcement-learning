...
void Mesh::initialize_vertex_buffer()
{
    ...
    */
    ...
    assign_coords_to_buffer();

}

void Mesh::assign_coords_to_buffer()
{
...
void Mesh::Draw(Shader &shader)
{
    ...
    */
    binding_textures_from_shaders(shader);
...
void Mesh::binding_textures_from_shaders(Shader &shader)
{
